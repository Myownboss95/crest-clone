<template>
  ...
  <breadcrumb title="Create Plan" :crumbs="['Dashboard', 'Settings', 'Tradeable assets', 'Create']" />
  <div class="col-lg-4 m-auto">
    <div class="card">
      <div class="card-body">
        <form @submit.prevent="createAsset">
          <FormGroup name="name" placeholder="Asset name" label="Asset name" v-model="form.name" />


          <FormSelect id="demo" name="type" label="Demo Plan"
            :options="{ 'crypto': 'Crypto Currency', 'stock': 'Stock', 'option': 'Option', 'future': 'Future' }" v-model="form.type" />
